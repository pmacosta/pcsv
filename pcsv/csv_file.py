...
class CsvFile(object):
    ...
    .. pcsv.csv_file.CsvFile.__init__
    ...
    def __repr__(self):
        ...
        For example:
            ...
            True
            >>> repr(obj1)
            "pcsv.CsvFile(fname=r'...', dfilter=['a'])"
        """
        dfilter_list = (
    ...
    def __str__(self):
        ...
        For example:
            ...
            >>> import pmisc, pcsv
            >>> with pmisc.TmpFile() as fname:
            ...     pcsv.write(fname, [['a', 'b'], [1, 2], [3, 4]])
            ...     obj = pcsv.CsvFile(fname, dfilter='a')
            ...
    ...
    def add_dfilter(self, dfilter):
        ...
        .. [[[cog cog.out(exobj.get_sphinx_autodoc()) ]]]
        .. Auto-generated exceptions documentation for
        .. pcsv.csv_file.CsvFile.add_dfilter
