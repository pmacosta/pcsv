...
man_pages = [
    ('index', 'Pcsv library', u'src Documentation',
...
texinfo_documents = [
  (
    ...
    'Pcsv library',
    (
        'This module can be used to handle comma-separated values (CSV) '
        'files and do lightweight processing of their data with support for '
