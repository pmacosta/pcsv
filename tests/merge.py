...
def test_merge():
    ...
    with pmisc.TmpFile(write_input_file) as fname1:
        with pmisc.TmpFile(write_replacement_file) as fname2:
            pcsv.merge(fname1, fname2, 'Ref', 'H2')
        obj = pcsv.CsvFile(fname=fname1, has_header=True)
    ...
    with pmisc.TmpFile(write_input_file) as fname1:
        with pmisc.TmpFile(write_replacement_file) as fname2:
            pcsv.merge(fname1, fname2, ['Ref', 'Data1'], ['H2', 'H4'])
        obj = pcsv.CsvFile(fname=fname1, has_header=True)
    ...
    with pmisc.TmpFile(write_input_file) as fname1:
        with pmisc.TmpFile(write_replacement_file) as fname2:
            pcsv.merge(fname1, fname2, has_header1=False)
        obj = pcsv.CsvFile(fname=fname1, has_header=True)
    assert obj.header() == [
    ...
    with pmisc.TmpFile(write_input_file) as fname1:
        with pmisc.TmpFile(write_replacement_file) as fname2:
            pcsv.merge(fname1, fname2, has_header2=False)
        obj = pcsv.CsvFile(fname=fname1, has_header=True)
    assert obj.header() == [
    ...
    with pmisc.TmpFile() as ofname:
        with pmisc.TmpFile(write_input_file) as fname1:
            with pmisc.TmpFile(write_replacement_file) as fname2:
                pcsv.merge(fname1, fname2, ofname=ofname)
    ...
    with pmisc.TmpFile(write_input_file) as fname1:
        with pmisc.TmpFile(write_replacement_file) as fname2:
            pcsv.merge(fname1, fname2, frow1=3, frow2=4)
        obj = pcsv.CsvFile(fname=fname1, has_header=True)
    assert obj.header() == [
        'Ctrl', 'Ref', 'Data1', 'Data2', 'H1', 'H2', 'H3', 'H4'
    ]
